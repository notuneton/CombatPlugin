...
public class Guide implements CommandExecutor {
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
        ...
        switch (args.length) {
            case 1:
                if ("komennot".equalsIgnoreCase(args[0]) || "k".equalsIgnoreCase(args[0])) {
    ...
    private void sendBasicCommands(Player player) {
        ...
        player.sendMessage(ColorUtils.colorize("&x&2&E&2&E&2&E&l- &7/kys | Kill Yourself."));
    ...
    private void sendAdminCommands(Player player) {
        ...
        player.sendMessage(ColorUtils.colorize("&x&2&E&2&E&2&E&l- &7/trap <player> | Create a cube around the player that the player cannot break."));
        player.sendMessage(ColorUtils.colorize("&x&2&E&2&E&2&E&l- &7/sudo <target> <message> | Executes another player perform a task."));
